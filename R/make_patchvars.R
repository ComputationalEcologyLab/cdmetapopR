...
make_patchvars <- function(output_file = "my_new_patchvars.csv") {
  ...
  template <- data.frame(
    PatchID = 0, X = NA, Y = NA,
    SubpatchNO = 0, K = 100, `K StDev` = 0, N0 = 100,
